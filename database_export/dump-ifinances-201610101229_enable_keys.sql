...
--
-- Host: 192.168.43.138    Database: ifinances
-- ------------------------------------------------------
...
INSERT INTO `APP_USER` VALUES (1,'sam','$2a$10$4eqIF5s/ewJwHK1p8lqlFOEm2QIA0S8g6./Lok.pQxqcxaBZYChRm','Sam','Smith','samy@xyz.com'),(2,'dima','$2a$10$3Z7ZgNxEf.imzYCovgbdRukDwYHZ7lcBUFK6hZtWpyKu.RaNXtGr2','Dima','Borisevich','dima@tut.by');
...
--
-- Temporary view structure for view `v_user_credential`
--
...
/*!50001 CREATE VIEW `v_user_credential` AS SELECT 
 1 AS `user_id`,
 1 AS `FIRST_NAME`,
 1 AS `last_name`,
 1 AS `USERNAME`,
...
--
-- Dumping routines for database 'ifinances'
--
...
-- Dump completed on 2016-10-10 12:29:05
