...
public class AppController {
    ...
    public String listUsers(ModelMap model) {
        ...
        List<Login> users = loginService.findAll();
    ...
    public String saveUser(@Valid Login login, BindingResult result,
		 ...
		 * 
		 */
        if (!loginService.isLoginSSOUnique(login.getId(), login.getSsoId())) {
    ...
    public String deleteUser(@PathVariable String ssoId) {
        loginService.deleteLoginBySSO(ssoId);
    ...
    public List<LoginProfile> initializeProfiles() {
